...
<table>
 ...
 `  <tr>
    ...
    <td style="text-align: right; font-size: 9px">${(item.quantity * item.unitPrice)}</td>
  </tr>`
   ))
  }
...
<section class="summary">
    <table>
        ...
        <tr>
            <td style="font-size: 10px">Delivery</td>
            <td style="text-align: right; font-size: 9px; font-weight: 700">${delivery}</td>
        </tr>
